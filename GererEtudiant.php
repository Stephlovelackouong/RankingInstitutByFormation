...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="index2.php" class="nav-item nav-link">Accuiel</a>
        ...
        <div class="row">
            <div>
                <form action="gererEtudiant.php" method="POST">
                    <input type="test" name="search" class="inputtbn" >
                    <button class="btn btn-primary center rounded ss" type="submit"> Recherche</button>
                </form>
            </div>
            <div>
	...
	<?php 	$results = mysqli_query($db,"SELECT * FROM etudiant");
	?>
	...
	?>
		...
		<td>  <a href="GererEtudiant.php?edit=<?php echo $row['matricule']; ?>" class="edit_btn">Edit</a></td>
		<td>  <a href="usered.php?delete=<?php echo $row['matricule']; ?>" class="del_btn">Delete</a></td>
            </tr>
...
if (isset($_GET['edit']))
	{$matricule = $_GET['edit'];
	 $update = true;
	 $record = mysqli_query($db, "SELECT * FROM etudiant WHERE matricule='$matricule'");
	...
	<form method="post" action="usered.php" class="con">
    <h3>Modifiers un etudiant ici</h3>

<label><b>Matricule</b></label>
<input type="text" class="inputtbn" placeholder="Entrer le matricule etudiant" name="matricule" value="<?php echo $matricule; ?>" required/>

<label><b>Nom</b></label>
<input type="text" class="inputtbn" placeholder="Entrer le nom etudiant" name="nom" value="<?php echo $nom; ?>" required/>

<label><b>Prenom </b></label>
<input type="text" class="inputtbn" placeholder="Entrer le prenom etudiant" name="prenom" value="<?php echo $prenom; ?>" required/>

<label><b>Email</b></label>
<input type="email" class="inputtbn" placeholder="Entrer l'email etudiant" name="email"name="email" value="<?php echo $email; ?>" required/>

<div class="input-group">
		<?php if ($update == true): ?>
	<button class="input" type="submit" name="update"  >MISE A JOUR</button>
		<?php endif ?>
	</div>
    </form>
    </div>
  ...
  <div class="container-fluid bg-dark text-light footer my-6 mb-0 py-6 wow fadeIn" data-wow-delay="0.1s">
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    <h4 class="text-light mb-4">FERMER LA SESSION</h4>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-center text-md-end">
                    ...
                    Designer avec <a href="404.php">HTML CSS PHP JS Bootstrap</a>
