...
<body>
    ...
    <div class="container-fluid page-header py-6 my-6 mt-0 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4"> Newsletter</h1>
    ...
    <!-- Page Header End -->
            ...
            <div>
                <div>
                    <div class="aa">
                        <div class="contenerr">
                    <p class="lead">S'abonner a la Newslette </p>
                            <p>Vous devez vous abonner pour continuellement recevoir les notification concernant le site</p><br/>
