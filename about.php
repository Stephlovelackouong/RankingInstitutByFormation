    ...
    <div class="container-xxl py-6">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h3 class="text-primary text-uppercase mb-2">Documentation</h3>
                <p><h6 class="text-primary text-uppercase mb-2">Classer des universités comme des équipes sportives </h6> 
Les classements d’universités («league tables») sont de plus en plus prisés depuis quelque temps et suscitent l’enthousiasme non seulement du public et des médias, mais aussi des universités – du moins celles qui sont fières de leur rang.
<h6 class="text-primary text-uppercase mb-2">Les classements existent depuis les années 1920 </h6> 
Ils sont devenus en quelques années incontournables dans la vie universitaire, pour le meilleur comme le pire. Leurs promesses varient en fonction du groupe qu’ils visent: la transparence sur le secteur universitaire – aussi essentiel qu’onéreux dans les sociétés modernes; une aide à l’évaluation de la qualité et à la sélection d’un établissement pour les étudiants et leurs parents, les jeunes enseignants et scientifiques et les candidats à des formations continues ou de cadres, mais aussi pour les parrains potentiels et la classe politique. Ils ouvrent donc un champ de concurrence publique entre les universités, qui y trouvent un instrument marketing leur permettant de faire miroiter leurs bons scores et d’accroître leur notoriété internationale. Les league tables induisent à penser que le travail d’enseignement et de recherche s’évalue aussi aisément que les performances d’un club de football. Elles ont un impact considérable, bien que les choses ne soient en fait pas si simples, et qu’il convienne d’examiner soigneusement les diverses méthodes utilisées.
<h6 class="text-primary text-uppercase mb-2">Un grand nombre de classements divers</h6>
Deux classements ont beaucoup fait parler d’eux récemment: le Shanghai ranking of world class universities que publie l’université Jiao Tong de Shanghai depuis 2003 (classement de Shanghai), et le ranking of world universities que publie le Times Higher Education Supplement (THES) depuis 2004. Mais il a existé des classements bien avant; ils étaient toutefois moins ambitieux, se confinant à certaines activités universitaires, à l’échelle d’un pays. La qualité des programmes de premier cycle a fait l’objet d’enquêtes d’évaluation depuis les années vingt aux Etats-Unis, mais c’est en 1983 que les organes de presse sont entrés en lice, lorsque le US News and World Report a lancé son America’s Best Colleges Ranking. Il s’agissait d’aider les étudiants et leurs parents à choisir une université. Aujourd’hui, les classements se sont élargis et diversifiés, prenant même récemment une dimension mondiale. Les méthodes de définition et de mesure de la qualité varient et sont souvent controversées. Or la généralisation et l’impact croissant d’un nouvel instrument aussi puissant comportent des risques non négligeables à partir du moment où l’on ne sait pas très bien ce qu’il mesure ni ce que seront ses effets sur le système universitaire
